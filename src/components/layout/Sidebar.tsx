...
import {
  ...
  Target, BookOpen, Sparkles, LogOut, Bot, Menu, X
} from 'lucide-react';
...
export function Sidebar() {
  ...
  // On mobile: show hamburger button + overlay sidebar
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className={cn('flex-shrink-0 border-t border-sidebar-border', showLabels ? 'p-3' : 'p-2')}>
          <div className={cn('flex items-center gap-2 mb-2', !showLabels && 'justify-center')}>
